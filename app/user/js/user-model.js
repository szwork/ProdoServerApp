...
var userSchema = mongoose.Schema({
  ...
  products_followed: [{prodle:{type:String,ref:"product"},orgid:{type:String,ref:"organizations"},followdate:{type:Date,default:null}}], //list of prodle - product ids handles #12934xyz
